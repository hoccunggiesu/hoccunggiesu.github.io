# 📚 Cơ sở dữ liệu các dòng tu, tu hội & chủng viện Công giáo tại Việt Nam

[![License: GPLv3](https://img.shields.io/badge/License-GPLv3-blue.svg)](./LICENSE)
[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC%20BY--SA%204.0-lightgrey.svg)](./LICENSE)

Dự án xây dựng **bộ dữ liệu mở** về các dòng tu, tu hội, tu đoàn và cơ sở đào tạo Công giáo đang hoạt động tại Việt Nam. Mục tiêu: phục vụ tra cứu ơn gọi, tìm hiểu thông tin, và kết nối cộng đồng đức tin.

---

## 🗂️ Cấu trúc thư mục (Version 2.0)
...
│   ├── search.md                       # Thẻ tìm kiếm (ngắn gọn)
...
- ✅ **Tôn trọng sự thật và bản quyền:** Chỉ sử dụng thông tin từ nguồn uy tín (sách đã xuất bản, website giáo phận, Vatican News).
- ✅ **Giữ đúng cấu trúc:** Không xóa hay đổi tên các trường quan trọng.
- ✅ **Cập nhật đồng bộ:** Nếu thay đổi thông tin ở `search.md`, kiểm tra lại `minimal.md` và `full.md`.
- ✅ **Ghi rõ nguồn:** Khi có thể, thêm link/sách tham khảo ở cuối file.
